...
5. **OK-VQA** Introduced by *Kenneth Marino, Mohammad Rastegari, Ali Farhadi, Roozbeh Mottaghi* in **OK-VQA: A Visual Question Answering Benchmark Requiring External Knowledge.** CVPR, 2019. [[Paper]](https://arxiv.org/pdf/1906.00067)
6. **A-OKVQA** Introduced by *Dustin Schwenk, Apoorv Khandelwal, Christopher Clark, Kenneth Marino, Roozbeh Mottaghi* in **A-OKVQA: A Benchmark for Visual Question Answering Using World Knowledge.** ECCV, 2022. [[Paper]](https://arxiv.org/abs/2206.01718)
7. **K-VQG** Introduced by *Kohei Uehara and Tatsuya Harada* in **K-VQG: Knowledge-aware Visual Question Generation for Common-sense Acquisition.** WACV, 2023. [[Paper]](https://arxiv.org/abs/2203.07890)
8. **VisualSimpleQA** Introduced by *Yanling Wang and Yihan Zhao and Xiaodong Chen and Shasha Guo and Lixin Liu and Haoyang Li and Yong Xiao and Jing Zhang and Qi Li and Ke Xu* in **VisualSimpleQA: A Benchmark for Decoupled Evaluation of Large Vision-Language Models in Fact-Seeking Question Answering.** arxiv, 2025. [[Paper]](https://arxiv.org/abs/2503.06492)
